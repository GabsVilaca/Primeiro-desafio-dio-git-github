# Anotações sobre semântica no CSS

Identifica-se a estrutura a ser destacada por uma id ou classe, sendo que a id só pode ser utilizada uma vez durante o código. 

Para fazer a concatenação de uma id usa-se o "#", para uma classe se utiliza um ".", e para fazer a concatenação de toda uma section, pode-se apenas escrever o nome da mesma na página CSS, como no exemplo a seguir:
...
Alguns parâmetros utilizados são o border, que pode ter 3 valores: largura, cor e estilo.
